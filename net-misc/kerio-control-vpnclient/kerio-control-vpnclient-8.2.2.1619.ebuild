...
SRC_URI="http://eu.download.kerio.com/dwn/control/control-${MY_PV}/kerio-control-vpnclient-${MY_PV}-linux.deb"
...
dolib.so  "./usr/lib/libktcrypto.so.1.0.0"
dolib.so "./usr/lib/libktssl.so.1.0.0"
